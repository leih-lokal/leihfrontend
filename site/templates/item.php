      ...
      <div class="lg:col-span-1">
        ...
        <?php if ($firstImage): ?>
          <div class="border border-gray-200 p-4 bg-white">
            <a href="https://stage.leihlokal-ka.de/api/files/item/<?= $recordId ?>/<?= trim($firstImage) ?>"
               data-lightbox="item-<?= $page->iid() ?>"
               data-title="<?= $page->name() ?>">
              <img
                src="https://stage.leihlokal-ka.de/api/files/item/<?= $recordId ?>/<?= trim($firstImage) ?>?thumb=300x300f"
                alt="<?= $page->name() ?>"
